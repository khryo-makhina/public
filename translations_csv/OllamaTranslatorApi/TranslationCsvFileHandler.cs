...
internal class TranslationCsvFileHandler
{
    ...
    /// </remarks>
    /// <param name="input">String input might already be containing double quotes or none.</param>
    /// <returns>
    ///     Cleaned string double-quoted both ends. If the input string is null or empty, it returns an empty quoted
    ///     string ("").
    /// </returns>
